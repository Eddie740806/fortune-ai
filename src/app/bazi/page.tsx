            ...
            <div className="space-y-6">
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  className="w-5 h-5 rounded border-2 border-amber-400/50 bg-indigo-950/50 text-amber-500 focus:ring-amber-400/30 focus:ring-offset-0 cursor-pointer"
                />
                <span className="text-amber-300/80 group-hover:text-amber-200 transition-colors">
                  記住我的資料（下次不用重填）
                </span>
              </label>
